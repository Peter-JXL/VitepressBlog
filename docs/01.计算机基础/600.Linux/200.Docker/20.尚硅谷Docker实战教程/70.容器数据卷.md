...
feed:
  enable: true
description: 上一篇启动 registry 的时候，用了 -v 和--privileged 参数，本文就讲解这两个参数的含义
...
> 有点类似 [Redis](https://www.peterjxl.com/Java-Framework/Redis/) 里面的 rdb 和 aof 文件，将容器内的数据保存进宿主机的磁盘中。
