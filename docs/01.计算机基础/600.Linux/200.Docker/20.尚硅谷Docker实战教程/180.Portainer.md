...
feed:
  enable: true
description: 随着 Docker 内实例越来越多，就得涉及到监控以及统计的需求：有多少个容器？运行的有几个？有哪些容器 CPU 使用率低？...
---
# 180.Portainer
...
安装文档：[https://docs.portainer.io/start/install-ce](https://docs.portainer.io/start/install-ce)
‍
...
​![](https://image.peterjxl.com/blog/image-20240829220732-ydkmq6g.png)​
