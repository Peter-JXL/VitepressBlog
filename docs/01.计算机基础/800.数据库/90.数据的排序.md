---
title: 数据的排序
date: 2023-11-20 17:29:05
permalink: /Computer/MySQLorder-by/
categories:
  - 计算机基础
  - 数据库
tags:
...
feed:
  enable: true
description: 通过 SQL 查询得到的结果，排列顺序通常是随机的，但我们可以使用 order by 子句进行排序。
---
# 90.数据的排序
...
​![](https://image.peterjxl.com/blog/image-20241204163758-u4544cr.png)​
‍
