---
title: mysqladmin
date: 2023-12-08 17:29:05
permalink: /Computer/MySQLmysqladmin/
categories:
  - 计算机基础
  - 数据库
tags:
...
feed:
  enable: true
description: ​mysqladmin ​是一个 MySQL ​服务器命令行工具，可以方便地执行一些基本的命令，例如更改 root 密码、监控 mysql 进程、重新加载权限、检查服务器状态等任务。
---
# mysqladmin 
