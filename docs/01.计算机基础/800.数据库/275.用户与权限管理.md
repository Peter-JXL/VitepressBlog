---
title: 用户与权限管理
date: 2023-12-05 17:29:05
permalink: /Computer/MySQLuser-privilege-management/
categories:
  - 计算机基础
  - 数据库
tags:
...
feed:
  enable: true
description: 用户与权限管理主要有以下作用：1. 对用户进行增删改查、2. 对用户进行密码管理、3. 限制用户登录的 IP 或域名...
---
# 用户与权限管理
...
[mysql grant 用户权限总结_mysqlgrant-CSDN 博客](https://blog.csdn.net/anzhen0429/article/details/78296814)
