...
* `maxUploadSize`：上传的最大文件大小，字节为单位。例如限制为 10M，则 10 * 1024 * 1024 = 10485760
‍
...
本项目已将源码上传到 [GitHub](https://github.com/Peter-JXL/LearnSpringMVC) 和 [Gitee](https://gitee.com/peterjxl/LearnSpringMVC) 上。并且创建了分支 demo8，读者可以通过切换分支来查看本文的示例代码。
‍