...
```
‍
重启，访问 [http://localhost: 8080/param/testParam](http://localhost:8080/param/testParam) 并点击超链接，可以看到能正常跳转，并且控制台有输出 testParam
...
‍
本项目已将源码上传到 [GitHub](https://github.com/Peter-JXL/LearnSpringMVC) 和 [Gitee](https://gitee.com/peterjxl/LearnSpringMVC) 上。并且创建了分支 demo3，读者可以通过切换分支来查看本文的示例代码。
