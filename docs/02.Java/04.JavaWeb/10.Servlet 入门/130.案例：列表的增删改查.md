...
为了和之前的项目区分，这里新建一个项目 LearnJavaWebUserManage。
‍
然后在项目右键--添加框架支持，选择添加 Web 应用程序
...
本次案例是一个综合性的练习，本文所有代码已提交到 [Gitee](https://gitee.com/peterjxl/learn-java-web-user-manage) 和 [GitHub](https://github.com/Peter-JXL/LearnJavaWebUserManage) 上，并创建了分支 Version1.0 作为本文的分支代码，然后读者完成了其他功能并提交到了 master 分支上，有需要的同学可以自行获取。
‍