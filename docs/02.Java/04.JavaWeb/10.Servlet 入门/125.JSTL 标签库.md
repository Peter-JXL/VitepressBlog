...
feed:
  enable: true
description: JSTL，全称 JavaServer Pages Tag Library，译为 JSP 标准标签库，是由 Apache 组织提供的开源的免费的 JSP 标签，用于简化和替换 JSP 页面上的 Java 代码
...
> 无法在 web.xml 或使用此应用程序部署的 jar 文件中解析绝对 uri：[http://java.sun.com/jsp/jstl/core]
‍
可以尝试这样解决：打开 IDEA 的项目设置，查看 2 是否有 lib 目录，且里面有 jar 包，如果没有，则点击 3 就会生成 lib 目录，并会在编译的输出路径下有 jar 包
