...
1. 装饰模式，我们在学习 IO 的时候讲过了：[Decorator 模式](https://www.peterjxl.com/Java-IO/4-Decorator/#%E4%BD%BF%E7%94%A8%E8%A3%85%E9%A5%B0%E5%99%A8%E6%A8%A1%E5%BC%8F%E4%B9%8B%E5%89%8D)
2. 代理模式。我们在讲解 Nginx 的时候，已经说过什么是代理了，而设计模式中的代码模式，就相当于创建一个代理对象，这个代理对象比之前的对象加强了一些功能。这里介绍几个名词：
‍
代理模式有两种实现模式：
...
‍
我们使用 `Proxy.newProxyInstance()` 来创建代理对象，该方法需要 3 个参数：
