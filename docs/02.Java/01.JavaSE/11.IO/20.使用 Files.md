...
feed:
  enable: true
description: 从 Java 7 开始，提供了 Files 这个工具类，能极大地方便我们读写文件。对于简单的小文件读写操作，可以使用 Files 工具类简化代码。
...
从 Java 7 开始，提供了 `Files` 这个工具类，能极大地方便我们读写文件。对于简单的小文件读写操作，可以使用 `Files` 工具类简化代码。
