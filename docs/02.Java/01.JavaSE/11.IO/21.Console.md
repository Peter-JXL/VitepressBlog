...
feed:
  enable: true
description: 有时候，我们需要输入密码，此时如果用 System.in 会让密码明文显示到控制台上；而 Console 类能隐式输入密码。
...
[Java Console 类示例 - Java 输入/输出教程](https://www.yiibai.com/java_io/console.html#article-start)