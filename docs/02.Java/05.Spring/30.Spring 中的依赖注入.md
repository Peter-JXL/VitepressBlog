...
1. 在 service 层中，新建几个成员变量，其中包含了基本类型和 String 类型，和其他 bean 类型（Date 也可以用 Bean 来管理）
...
本项目已将源码上传到 [GitHub](https://github.com/Peter-JXL/LearnSpring) 和 [Gitee](https://gitee.com/peterjxl/LearnSpring) 上。并且创建了分支 demo3，读者可以通过切换分支来查看本文的示例代码。
