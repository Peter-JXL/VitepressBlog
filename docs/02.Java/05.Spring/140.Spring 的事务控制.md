...
2. 开启连接的代码，我们可以在获取 connection 的时候，直接开启事务
‍
...
本项目已将源码上传到 [GitHub](https://github.com/Peter-JXL/LearnSpring) 和 [Gitee](https://gitee.com/peterjxl/LearnSpring) 上。并且创建了分支 demo17，读者可以通过切换分支来查看本文的示例代码
