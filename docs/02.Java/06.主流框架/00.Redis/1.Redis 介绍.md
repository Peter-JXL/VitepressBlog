...
Redis 中文网：[http://www.redis.net.cn/](http://www.redis.net.cn/)
...
Redis 的代码托管在 [GitHub](https://github.com/redis/redis) 上，开发十分活跃 ，截止到 2023-4 月，已有近 60k 的 star，贡献者有 660 个。良好的开发氛围和严谨的版本发布机制使得 Redis 的稳定版本非常可靠，如此多的公司在项目中使用了 Redis 也可以印证这一点。
