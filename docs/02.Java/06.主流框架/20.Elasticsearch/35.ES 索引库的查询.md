...
feed:
  enable: true
description: 上一篇讲了怎么维护索引库，接下来讲讲常见的查询操作。
...
之前我们学 Lucene 时，讲过 [使用 queryparser 查询](https://www.peterjxl.com/Lucene/Query/#%E4%BD%BF%E7%94%A8queryparser%E6%9F%A5%E8%AF%A2)；ES 当然也支持。请求 URL：
