...
feed:
  enable: true
description: 本文讲解更多关于 Lombok 的常用注解
---
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnLombok) 或 [GitHub](https://github.com/Peter-JXL/LearnLombok) 的分支 demo2，读者可以通过切换分支来查看本文的示例代码
‍