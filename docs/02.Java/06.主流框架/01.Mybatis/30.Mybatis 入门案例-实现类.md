...
feed:
  enable: true
description: 我们之前说过，Mybatis 可以创建代理对象，这样我们就不用写实现类了；但如果我们实在想自己实现实现类也是可以的。
---
# Mybatis 入门案例-实现类
...
本文所有代码已上传到了 [GitHub](https://github.com/Peter-JXL/LearnMybatis) 和 [Gitee](https://gitee.com/peterjxl/LearnMybatis) 上，并且创建了分支 demo3，读者可以通过切换分支来查看本文的示例代码。
