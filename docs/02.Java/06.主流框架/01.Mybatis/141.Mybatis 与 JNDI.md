...
feed:
  enable: true
description: JNDI，全称 Java Naming and Directory Interface，Java 命名与目录接口，是 SUN 公司推出的一套规范，属于 JavaEE 技术之一，目的是模仿 Windows 系统中的注册表，提供一些资源给应用
---
# Mybatis 与 JNDI
...
本文所有代码已上传到了 [GitHub](https://github.com/Peter-JXL/LearnMybatis) 和 [Gitee](https://gitee.com/peterjxl/LearnMybatis) 上，并且创建了分支 demo16，读者可以通过切换分支来查看本文的示例代码。
