...
我们用 collection 属性表示查询一个集合出来，`ofType` 表示集合中元素的类型；然后里面写 account 表的列
‍
...
本文所有代码已上传到了 [GitHub](https://github.com/Peter-JXL/LearnMybatis) 和 [Gitee](https://gitee.com/peterjxl/LearnMybatis) 上，并且创建了分支 demo14，读者可以通过切换分支来查看本文的示例代码。
