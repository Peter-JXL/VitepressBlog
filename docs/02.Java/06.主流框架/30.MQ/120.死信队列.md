...
DLK：全称 x-dead-letter-routing-key，也就是有设置死信消息的 routing key
‍
也可以看到有交换机：
...
已将源码上传到 [Gitee](https://gitee.com/peterjxl/LearnMQ) 或 [GitHub](https://github.com/Peter-JXL/LearnMQ) 上。并且创建了分支 demo9，读者可以通过切换分支来查看本文的示例代码
‍