...
feed:
  enable: true
description: 讲讲 RabbitMQ 的其他的小知识
...
本项目已将源码上传到 [Gitee](https://gitee.com/peterjxl/LearnMQ) 或 [GitHub](https://github.com/Peter-JXL/LearnMQ) 上。并且创建了分支 demo10，读者可以通过切换分支来查看本文的示例代码
