...
feed:
  enable: true
description: 为了防止宕机，我们可以使用发布确认模式，来确保消息不丢失；除此之外还可以加个备份交换机
...
已将源码上传到 [Gitee](https://gitee.com/peterjxl/springboot-rabbitmq) 或 [GitHub](https://github.com/Peter-JXL/springboot-rabbitmq) 上。并且创建了分支 demo4，读者可以通过切换分支来查看本文的示例代码
