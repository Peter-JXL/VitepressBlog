...
feed:
  enable: true
description: 接下来我们来使用 SpringMVC 完成 web 层的编写
---
# 114.使用 Maven 完成 web 层

接下来我们来使用 SpringMVC 完成 web 层的编写
<!-- more -->
‍
...
新建 src/main/resources/springmvc.xml：
...
我们新建 webapp\WEB-INF\pages\itemDetail.jsp：
...
本项目已将源码上传到 [Gitee](https://gitee.com/peterjxl/LearnJavaMaven) 和 [GitHub](https://github.com/Peter-JXL/LearnJavaMaven) 上。并且创建了分支 demo6web，读者可以通过切换分支来查看本文的示例代码。
‍