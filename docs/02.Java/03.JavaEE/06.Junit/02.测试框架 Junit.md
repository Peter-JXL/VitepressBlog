...
语法：`Assert.assertEquals(期望的结果,运算的结果);` assertEquals 有很多重载的方法，这里简单说一个
...
可以在官网下载 [JUnit](https://junit.org/)，新版本的 Junit 分了几个模块
...
[单元测试（三）了解 JUnit 包 - 跃小云 - 博客园](https://www.cnblogs.com/yuexiaoyun/articles/15597902.html)
