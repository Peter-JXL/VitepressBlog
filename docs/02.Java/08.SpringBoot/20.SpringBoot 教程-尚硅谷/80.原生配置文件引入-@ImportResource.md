...
feed:
  enable: true
description: 如果项目之前是使用 Spring，并且用了配置文件，那么迁移到配置类的方式，会非常麻烦；为此我们可以用@ImportResource 注解，导入该配置文件。我们来演示下：
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot) 的分支 demo6，读者可以通过切换分支来查看本文的示例代码
‍