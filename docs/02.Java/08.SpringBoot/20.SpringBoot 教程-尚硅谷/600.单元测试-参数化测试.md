...
feed:
  enable: true
description: 参数化测试是 JUnit5 很重要的一个新特性，它使得用不同的参数多次运行测试成为了可能，也为我们的单元测试带来许多便利。
...
至此，Junit5 的教程就到这里了。如果要迁移，需要注意如下的变化（参考 [官网文档](https://junit.org/junit5/docs/current/user-guide/#migrating-from-junit4)）：
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo21，读者可以通过切换分支来查看本文的示例代码
