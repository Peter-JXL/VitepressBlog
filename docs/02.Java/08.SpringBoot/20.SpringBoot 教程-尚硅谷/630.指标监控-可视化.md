...
feed:
  enable: true
description: 介绍下使用第三方项目，来将监控数据展示
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo24，读者可以通过切换分支来查看本文的示例代码
