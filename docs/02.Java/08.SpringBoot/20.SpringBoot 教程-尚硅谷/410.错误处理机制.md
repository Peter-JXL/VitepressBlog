...
大意：默认情况下，Spring Boot 提供 `/error` 处理所有错误的映射。
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo6，读者可以通过切换分支来查看本文的示例代码
