...
feed:
  enable: true
description: 接下来说说断言（assertions）
...
在 JUnit4 时期，想要测试方法的异常情况时，需要用@Rule 注解的 ExpectedException 变量，还是比较麻烦的。而 JUnit5 提供了一种新的断言方式 `Assertions.assertThrows()` , 配合函数式编程就可以进行使用。
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo18，读者可以通过切换分支来查看本文的示例代码
