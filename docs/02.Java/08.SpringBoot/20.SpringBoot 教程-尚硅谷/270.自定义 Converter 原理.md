...
feed:
  enable: true
description: 上一篇博客，我们仅仅是讲了原理，接下来就来讲讲如何自定义 Converter，并且深入源码来分析原理
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot) 的分支 demo15，读者可以通过切换分支来查看本文的示例代码
