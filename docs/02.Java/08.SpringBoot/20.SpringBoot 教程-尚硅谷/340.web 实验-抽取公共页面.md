...
接下来我们看看 Thymeleaf 的 [官网文档](https://www.thymeleaf.org/doc/tutorials/3.1/usingthymeleaf.html#template-layout)，是如何说明抽取的：
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo2，读者可以通过切换分支来查看本文的示例代码
‍