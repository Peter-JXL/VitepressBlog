...
feed:
  enable: true
description: 使用 DevTools，可以做到热更新，也就是不重启项目，就能完成代码和页面的更新。
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot) 的分支 demo8，读者可以通过切换分支来查看本文的示例代码
