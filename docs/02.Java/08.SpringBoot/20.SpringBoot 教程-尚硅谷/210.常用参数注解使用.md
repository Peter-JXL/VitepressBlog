...
feed:
  enable: true
description: 一般来说，我们都是要从前端获取参数的，SpringBoot 提供了很多的方式
...
‍
例如，在方法参数里使用注解 `@RequestParam`，然后赋值给 name：
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot) 的分支 demo12，读者可以通过切换分支来查看本文的示例代码
