...
feed:
  enable: true
description: 本节课我们来学习整合 Mybatis-Plus，完成基本的查询功能
...
官网：[MyBatis-Plus](https://baomidou.com/)，GitHub 地址：[github.com/baomidou/mybatis-plus](https://github.com/baomidou/mybatis-plus)
‍
## MybatisX 插件

官网文档：[MybatisX 快速开发插件 | MyBatis-Plus](https://baomidou.com/pages/ba5b24/)
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo14，读者可以通过切换分支来查看本文的示例代码
