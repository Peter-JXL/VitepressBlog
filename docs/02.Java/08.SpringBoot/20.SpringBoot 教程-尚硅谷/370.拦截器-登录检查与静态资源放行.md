...
feed:
  enable: true
description:  之前我们说了 SpringBoot 处理请求的底层原理，接下来就来说说其他常用的 web 功能，例如拦截器、文件上传、异常处理等。
...
3. 指定拦截规则（注意放行静态资源）
‍
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot-Web-Admin) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot-Web-Admin) 的分支 demo4，读者可以通过切换分支来查看本文的示例代码
