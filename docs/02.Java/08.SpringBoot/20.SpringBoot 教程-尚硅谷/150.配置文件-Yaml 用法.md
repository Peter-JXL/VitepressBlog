...
feed:
  enable: true
description: SpringBoot 除了支持 properties，还支持 yaml 的配置文件（文件后缀可以是 yaml，也可以是 yml）
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot) 的分支 demo9，读者可以通过切换分支来查看本文的示例代码
