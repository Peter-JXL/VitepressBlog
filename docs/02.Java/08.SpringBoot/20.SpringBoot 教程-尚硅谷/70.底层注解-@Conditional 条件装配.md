...
feed:
  enable: true
description: 条件装配：满足 Conditional 指定的条件，则进行组件注入
...
已将本文源码上传到 [Gitee](https://gitee.com/peterjxl/LearnSpringBoot) 或 [GitHub](https://github.com/Peter-JXL/LearnSpringBoot) 的分支 demo5，读者可以通过切换分支来查看本文的示例代码
